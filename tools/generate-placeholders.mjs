...
export const IMAGES = [
  ['hero-plombier-intervention', 'Plombier professionnel en intervention', 'wrench', 3 / 2],
  ['depannage-plomberie', 'Dépannage de plomberie (robinetterie, alimentation)', 'gear', 3 / 2],
  ['debouchage-canalisation', 'Débouchage de canalisation', 'pipe', 3 / 2],
  ['degorgement', 'Dégorgement de réseau d’évacuation', 'coil', 3 / 2],
  ['debouchage-wc', 'Débouchage de WC', 'drop', 3 / 2],
  ['debouchage-evier', 'Débouchage d’évier de cuisine', 'tap', 3 / 2],
  ['debouchage-lavabo', 'Débouchage de lavabo', 'drop', 3 / 2],
  ['debouchage-douche', 'Débouchage de douche / baignoire', 'shower', 3 / 2],
  ['fuite-eau', 'Intervention sur une fuite d’eau', 'drop', 3 / 2],
  ['canalisation-bouchee', 'Canalisation bouchée', 'coil', 3 / 2],
  ['recherche-fuite', 'Recherche de fuite non visible', 'loupe', 3 / 2],
  ['urgence-plomberie', 'Intervention de plomberie en urgence', 'alert', 3 / 2],
  ['technicien-camion', 'Technicien plombier en déplacement', 'wrench', 3 / 2],
  ...
  ['equip-camion-plombier', 'Technicien devant le camion équipé', 'gear', 1]
];
