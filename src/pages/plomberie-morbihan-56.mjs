...
export default landingService({
  ...
  title: 'Plombier Morbihan (56) — fuite d’eau, déplacement 45 € | Plombier Breizh',
  description: 'Plombier à Vannes, Lorient, Auray et dans le Morbihan : fuite d’eau, chauffe-eau, robinetterie. Déplacement 45 € TTC, prix annoncé avant travaux. 02 20 06 01 96.',
  ...
  avis: avisParNoms('Sophie Le Gall', 'plomberie-56-a', 'plomberie-56-b', 'plomberie-56-c'),
