...
export default landingService({
  ...
  faq: [
    ...
    ['Combien coûte un débouchage ?',
     'Les frais de déplacement sont de 45 € TTC. Le prix du débouchage, lui, est établi sur place : l’accès et la méthode changent tout entre un point d’eau isolé et un réseau enterré. Le montant vous est annoncé avant que le travail commence, et un devis écrit vous est remis au-delà de 150 € TTC.'],
